...
function(ExtProjectGit repourl tag destination)
    ...
    message(STATUS "Get external project from: ${repourl} : ${tag} : ${dedestination} ")
	...
	message(STATUS "oneargs  ${oneValueArgs}")
	message(STATUS "mulargs  ${multiValueArgs}")
	message(STATUS "argn  ${ARGN} ")
	message(STATUS "dest  ${destination}")
	message(STATUS "toolchain  ${CMAKE_TOOLCHAIN_FILE} ")
	message(STATUS "ExtProjectGit_CMAKE_ARGS  ${ExtProjectGit_CMAKE_ARGS}")
